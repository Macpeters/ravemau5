...
if(__view_get( e__VW.WView, 0 ) != gvW || __view_get( e__VW.HView, 0 ) != gvH){
    ...
    if(gvW/__view_get( e__VW.WPort, 0 ) >= gvH/__view_get( e__VW.HPort, 0 )){
        __view_set( e__VW.HView, 0, lerp(__view_get( e__VW.HView, 0 ), gvH, 0.5) );
...
if instance_exists(gvObj) {
 gvX = min(max(0,gvObj.x-__view_get( e__VW.WView, 0 )/2+(__view_get( e__VW.WView, 0 )/10*gvObj.image_xscale)),room_width-__view_get( e__VW.WView, 0 ));
 gvY = min(max(0,gvObj.y-__view_get( e__VW.HView, 0 )/2),room_height-__view_get( e__VW.HView, 0 ));
}
//place the view
__view_set( e__VW.XView, 0, min(max(0,lerp(__view_get( e__VW.XView, 0 ),gvX,.15)),room_width-__view_get( e__VW.WView, 0 )) );
__view_set( e__VW.YView, 0, min(max(0,lerp(__view_get( e__VW.YView, 0 ),gvY,.3)),room_height-__view_get( e__VW.HView, 0 )) );
